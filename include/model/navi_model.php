...
class Navi_Model
{
    ...
    public function updateNavi($naviData, $navid)
    {
        $Item = array();
    ...
    public function addNavi($name, $url, $taxis, $pid, $newtab, $type = 0, $typeId = 0)
    {
    ...
    public function getOneNavi($navid)
    {
    ...
    public function getNaviNameByUrl($url)
    {
    ...
    public function getNaviNameByType($type)
    {
        $CACHE = Cache::getInstance();
        $navi_cache = $CACHE->readCache('navi');
        foreach ($navi_cache as $val) {
    ...
    public function deleteNavi($navid)
    {
